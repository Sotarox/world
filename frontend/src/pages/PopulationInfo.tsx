    ...
    return (
        <Box sx={{ mb: 3 }}>
          <Grid container spacing={1}>
              ...
              <Grid size={{ xs: 6, md: 3 }}>
                <InfoCard title="World:" 
                  value={populationRankWorld ? 
                    formatRankInfo(populationRankWorld.rank, populationRankWorld.countCountries) : "N/A"}/>
              </Grid>
              <Grid size={{ xs: 6, md: 3 }}>
                <InfoCard title="Continent:" 
                  value={populationRankContinent ? 
                    formatRankInfo(populationRankContinent.rank, populationRankContinent.countCountries) : "N/A"}/>
              </Grid>
          </Grid>
        </Box>
      )
